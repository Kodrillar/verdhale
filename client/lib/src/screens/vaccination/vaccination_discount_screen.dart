...
class VaccinationDiscountScreen extends StatefulWidget {
  const VaccinationDiscountScreen({
    Key? key,
  }) : super(key: key);

  @override
  _VaccinationDiscountScreenState createState() =>
      _VaccinationDiscountScreenState();
}

class _VaccinationDiscountScreenState extends State<VaccinationDiscountScreen> {
  ...
  int servicePrice = int.parse(ServicePriceModel.servicePrice["vaccination"]!);
  int discountPrice = int.parse(ServicePriceModel.servicePrice["vaccination"]!);
